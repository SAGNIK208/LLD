...
public class WithdrawingState implements ATMState {
    private final ATM atm;

    public WithdrawingState(ATM atm){
        this.atm = atm;
    }
    ...
    public Cash withdraw(int amount) {
        Cash cash = this.atm.getAtmInventory().dispenseCash(amount);
